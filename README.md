...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/registry | 16MB | 1000:1000 | ✅ | amd64, arm64, armv7 |
| registry | 62MB | 0:0 | ❌ | amd64, arm64v8, armv6, armv7, ppc64le, riscv64, s390x |
...
* [3.1.0](https://hub.docker.com/r/11notes/registry/tags?name=3.1.0)
* [3.1.0-unraid](https://hub.docker.com/r/11notes/registry/tags?name=3.1.0-unraid)
* [3.1.0-nobody](https://hub.docker.com/r/11notes/registry/tags?name=3.1.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/registry:3.1.0
docker pull ghcr.io/11notes/registry:3.1.0
docker pull quay.io/11notes/registry:3.1.0
```
...
*created 08.04.2026, 08:21:43 (CET)*